...
function NavBar() {
 ...
 <div className="flex justify-between">
  <div className="w-[50%]"><h1 className="text-[3rem] ">Mahnoor <span className="text-[#00ffee] font-extrabold cursor-pointer custom-shadow  logo">Sarfraz</span></h1></div>
  <div className="w-[50%]">
    <ul className="flex justify-around   text-[2rem] cursor-pointer font-medium ">
      ...
      <li className="hover:text-[#00ffee] hover:border-b-2 logo border-[#00ffee]">Contact</li>
    </ul>
  </div>
 </div>
  </Component>
